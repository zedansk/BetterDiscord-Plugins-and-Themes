//META{"name":"QuickDelete"}*// 
var QuickDelete = function() {
	this.getName = function() { return "QuickDelete"; };
	this.getDescription = function() { return "Adds a button next to the options button to quick delete a message."; };
	this.getVersion = function() { return "1.1"; };
	this.getAuthor = function() { return "confuseh"; };
}
